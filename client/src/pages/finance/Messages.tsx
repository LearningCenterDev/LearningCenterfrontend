...
interface FinanceMessagesProps {
...
export default function FinanceMessages({ financeAdminId }: FinanceMessagesProps) {
  ...
  const usersWithEmail = users.filter(u => u.email && u.id !== financeAdminId);
  const usersWithPhone = users.filter(u => u.phone && u.id !== financeAdminId);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800" data-testid="finance-messages-page">
      {/* Premium Header */}
      <div className="bg-gradient-to-r from-[#1F3A5F] via-[#1F3A5F] to-[#2a4a75] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-white">Communication Center</h1>
          </div>
          <p className="text-white/60 text-sm sm:text-base">Communicate with teachers, parents, and administrators via messages, email, or SMS</p>
        </div>
      </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white via-white to-slate-50/50 dark:from-slate-800/95 dark:via-slate-800 dark:to-slate-900/95 rounded-xl shadow-lg border border-slate-200/50 dark:border-slate-700/50 overflow-hidden backdrop-blur-sm">
                ...
                <div className="p-3 sm:p-4 md:p-5">
                  <MessagingInterface currentUserId={financeAdminId} />
                </div>
              </div>
            </div>
          </TabsContent>
